...
const schema = z.object({
  email: z.string().email("Digite o email do cliente").min(1,
      ...
      <main className='flex flex-col mt-4 mb-2'>
       ...
       {customer ? (
        ...
        flex items-center justify-between">
          ...
          <button className=' h-11 px-2 flex items-center justify-center
          rounded'
          ...
          >
            <div className='flex flex-col gap-3'>
              ...
              <button  type='submit' className='bg-blue-500 flex flex-row gap-3 px-2 h-11 
              items-center justify-center rounded text-white font-bold '>
                Procurar clientes
